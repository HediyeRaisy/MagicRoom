            ...
            if (p.GetCustomAttribute(typeof(PropertyOptional)) == null)
            {
                ...
                if (p.PropertyType == typeof(string))
                {
                    ...
                    if (p.GetCustomAttribute(typeof(PropertyReferenceFolder)) != null){
                        ...
                        return File.Exists(Application.streamingAssetsPath + "/" + prf.folder + "/" + filename + "." + prf.extension) || File.Exists("C:\\Magika\\Resources\\" + prf.folder + "\\" + filename + "." + prf.extension);
                    }
                    if (p.GetCustomAttribute(typeof(PropertyReferenceFolders)) != null)
                    {
                        ...
                        foreach (string f in prf.folder) {
                            if (File.Exists(Application.streamingAssetsPath + "/" + f + "/" + filename + "." + prf.extension) || File.Exists("C:\\Magika\\Resources\\" + f + "\\" + filename + "." + prf.extension))
                            {
                                return true;
                            }
                    ...
                    if (p.GetCustomAttribute(typeof(PropertyThemeSet)) != null){
                        ThemeManager.SetThemeByName(p.GetValue(config).ToString());
                    }
                }
            }
            else {
...
[System.AttributeUsage(System.AttributeTargets.Class | System.AttributeTargets.Struct | System.AttributeTargets.Property)]
public class PropertyThemeSet : System.Attribute { 
    public PropertyThemeSet()
    {
    }
}
