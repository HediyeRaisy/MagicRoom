...
public static class ThemeManager{
    ...
    public static void StartUp()
    {
        ...
        {
            Debug.LogError("theme directory C:\\Magika\\Resources");
            string themedirectory = "C:\\Magika\\Resources\\Themes";// "C://LUDOMI/Themes";
            ...
            {
                themedirectory = "C:\\Magika\\Resources\\themes";// "C://LUDOMI/Themes";
                Debug.Log(themedirectory);
                if (Directory.Exists(themedirectory))
                {
                    foreach (string s in Directory.GetFiles(themedirectory))
